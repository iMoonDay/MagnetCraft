...
public class BlockRegistries {
    ...
    public static final Block MAGNETITE_BLOCK = register("magnetite", new Block(FabricBlockSettings.copy(Blocks.IRON_ORE)), false);
    ...
    public static final Block DEEPSLATE_MAGNETITE_BLOCK = register("deepslate_magnetite", new Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_IRON_ORE)), false);
    public static final Block MAGNET_BLOCK = register("magnet_block", new Block(FabricBlockSettings.copy(Blocks.IRON_BLOCK)), false);
    public static final Block NETHERITE_MAGNET_BLOCK = register("netherite_magnet_block", new Block(FabricBlockSettings.copy(Blocks.NETHERITE_BLOCK)), false);
    public static final Block RAW_MAGNET_BLOCK = register("raw_magnet_block", new Block(FabricBlockSettings.copy(Blocks.RAW_IRON_BLOCK)), false);
    ...
    public static final MaglevDoorBlock MAGLEV_IRON_DOOR_BLOCK = register("maglev_iron_door", new MaglevDoorBlock(FabricBlockSettings.copy(Blocks.IRON_DOOR).nonOpaque(), BlockSetType.IRON), true);
    public static final MaglevDoorBlock MAGLEV_OAK_DOOR_BLOCK = register("maglev_oak_door", new MaglevDoorBlock(FabricBlockSettings.copy(Blocks.OAK_DOOR).nonOpaque(), BlockSetType.OAK), true);
    public static final MaglevRepeaterBlock MAGLEV_REPEATER_BLOCK = register("maglev_repeater", new MaglevRepeaterBlock(FabricBlockSettings.copy(Blocks.REPEATER).nonOpaque()), true);
    public static final MaglevComparatorBlock MAGLEV_COMPARATOR_BLOCK = register("maglev_comparator", new MaglevComparatorBlock(FabricBlockSettings.copy(Blocks.COMPARATOR).nonOpaque()), true);
    ...
    public static final DemagnetizerBlock DEMAGNETIZER_BLOCK = register("demagnetizer", new DemagnetizerBlock(FabricBlockSettings.copy(MAGNET_BLOCK)), false);
    ...
    public static final AttractSensorBlock ATTRACT_SENSOR_BLOCK = register("attract_sensor", new AttractSensorBlock(FabricBlockSettings.copy(MAGNET_BLOCK)), false);
    ...
    public static final AdvancedGrindstoneBlock ADVANCED_GRINDSTONE_BLOCK = register("advanced_grindstone", new AdvancedGrindstoneBlock(FabricBlockSettings.copy(Blocks.GRINDSTONE)), true);
    ...
    static <T extends Block> T register(String id, T block, boolean nonOpaque) {
        registerBlock(id, block, nonOpaque);
        registerBlockItem(id, new BlockItem(block, new FabricItemSettings()));
        return block;
    }

    static <T extends Block> T registerBlock(String id, T block, boolean nonOpaque) {
    ...
    static <T extends BlockItem> T registerBlockItem(String id, T blockitem) {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroupRegistries.MAGNETS).register(content -> content.add(blockitem));
        return blockitem;
    }
