...
import com.imoonday.magnetcraft.common.entities.bomb.ElectromagneticPulseBombEntityRender;
...
public class EntityRendererRegistries {
    ...
    public static void registerClient() {
        ...
        EntityRendererRegistry.register(EntityRegistries.ELECTROMAGNETIC_PULSE_BOMB, ElectromagneticPulseBombEntityRender::new);
    }
