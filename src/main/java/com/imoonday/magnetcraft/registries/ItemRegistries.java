...
import com.imoonday.magnetcraft.materials.MagneticIronArmorMaterial;
import com.imoonday.magnetcraft.materials.MagneticIronToolMaterial;
import com.imoonday.magnetcraft.materials.NetheriteMagneticIronArmorMaterial;
import com.imoonday.magnetcraft.materials.NetheriteMagneticIronToolMaterial;
...
public class ItemRegistries {
    ...
    public static final Item NETHERITE_MAGNETIC_IRON_INGOT = new Item(new FabricItemSettings().maxCount(64).fireproof());
    ...
    public static final Item MAGNETIC_IRON_HELMET = new ArmorItem(MAGNETIC_IRON_MATERIAL, EquipmentSlot.HEAD, new Item.Settings());
    public static final Item MAGNETIC_IRON_CHESTPLATE = new ArmorItem(MAGNETIC_IRON_MATERIAL, EquipmentSlot.CHEST, new Item.Settings());
    public static final Item MAGNETIC_IRON_LEGGINGS = new ArmorItem(MAGNETIC_IRON_MATERIAL, EquipmentSlot.LEGS, new Item.Settings());
    public static final Item MAGNETIC_IRON_BOOTS = new ArmorItem(MAGNETIC_IRON_MATERIAL, EquipmentSlot.FEET, new Item.Settings());

    public static final ArmorMaterial NETHERITE_MAGNETIC_IRON_MATERIAL = new NetheriteMagneticIronArmorMaterial();
    public static final Item NETHERITE_MAGNETIC_IRON_HELMET = new ArmorItem(NETHERITE_MAGNETIC_IRON_MATERIAL, EquipmentSlot.HEAD, new Item.Settings().fireproof());
    public static final Item NETHERITE_MAGNETIC_IRON_CHESTPLATE = new ArmorItem(NETHERITE_MAGNETIC_IRON_MATERIAL, EquipmentSlot.CHEST, new Item.Settings().fireproof());
    public static final Item NETHERITE_MAGNETIC_IRON_LEGGINGS = new ArmorItem(NETHERITE_MAGNETIC_IRON_MATERIAL, EquipmentSlot.LEGS, new Item.Settings().fireproof());
    public static final Item NETHERITE_MAGNETIC_IRON_BOOTS = new ArmorItem(NETHERITE_MAGNETIC_IRON_MATERIAL, EquipmentSlot.FEET, new Item.Settings().fireproof());
